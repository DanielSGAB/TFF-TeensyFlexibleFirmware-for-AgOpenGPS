...
// Wire1 is Teensy 4.1's second I2C bus (pins SDA=17, SCL=16).
// On non-Teensy targets it may not be declared — provide a forward
// declaration so the file compiles. On Teensy, Wire.h already defines it.
